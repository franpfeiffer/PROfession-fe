                ...
                <div className="max-w-md mx-auto">
                    <Card>
                        <CardHeader className="text-center">
                            ...
                            <CardDescription>Únete a OficiosPro y conecta con profesionales</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <Tabs defaultValue="client" className="w-full">
                                ...
                                <TabsContent value="client" className="space-y-4 mt-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input id="client-name" placeholder="Juan Pérez" className="pl-10" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input id="client-email" type="email" placeholder="juan@email.com" className="pl-10" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            ...
                                            <Input id="client-phone" placeholder="+54 342 123-4567" className="pl-10" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <input type="checkbox" id="client-terms" className="rounded" />
                                ...
                                <TabsContent value="professional" className="space-y-4 mt-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground h-4 w-4" />
                                            <Input id="pro-name" placeholder="Carlos Martínez" className="pl-10" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground h-4 w-4" />
                                            <Input id="pro-email" type="email" placeholder="carlos@email.com" className="pl-10" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative">
                                            <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground h-4 w-4" />
                                            <Input id="pro-phone" placeholder="+54 342 123-4567" className="pl-10" />
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <input type="checkbox" id="pro-terms" className="rounded" />
                                        <Label htmlFor="pro-terms" className="text-sm">
                                            Acepto los{" "}
                                            <Link href="/terms" className="text-primary hover:underline">
                                                términos y condiciones
                                            </Link>
